package OpenQA::WebAPI::Plugin::IssueReporter::KernelBug;
...
use OpenQA::WebAPI::Plugin::IssueReporter::SuseBugzillaUtils
...
See for detailes and context:
https://confluence.suse.com/spaces/qasle/pages/1836712232/Kernel+Bug+Reporting+Guidelines
